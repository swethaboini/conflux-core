...
public class ClientRecurringCharge extends AbstractPersistable<Long> {
    ...
    public static ClientRecurringCharge createNew(final Client client, final Charge charge, final JsonCommand command) {
        ...
        final Boolean synchMeeting = command.booleanPrimitiveValueOfParameterNamed(ClientApiConstants.chargesynchmeetingParamName );
        ...
        return new ClientRecurringCharge(client,charge,name, amount, currencyCode,dueDate,synchMeeting);
        
    }


    private ClientRecurringCharge(final Client client,final Charge charge,final String name, final BigDecimal amount, final String currencyCode,LocalDate dueDate,final Boolean synchMeeting) {
        this.charge=charge;
        this.client=client;
        this.name = name;
        this.amount = amount;
