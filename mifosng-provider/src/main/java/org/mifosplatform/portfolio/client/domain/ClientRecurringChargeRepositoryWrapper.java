...
public class ClientRecurringChargeRepositoryWrapper {
	...
	@Autowired
	public ClientRecurringChargeRepositoryWrapper(
			final ClientRecurringChargeRepository repository) {

		this.repository = repository;
	}

	public ClientRecurringCharge findOneWithNotFoundDetection(final Long id) {
		final ClientRecurringCharge clientRecurringCharge = this.repository
				.findOne(id);
		if (clientRecurringCharge == null) {
