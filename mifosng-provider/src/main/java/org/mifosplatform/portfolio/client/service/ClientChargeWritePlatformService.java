...
public interface ClientChargeWritePlatformService {
	...
	@Transactional
	CommandProcessingResult payCharge(Long clientId, Long clientChargeId,
			JsonCommand command);
	...
	@Transactional
	Map<String, Object> payChargeFromCollectionsheet(CollectionSheetChargeRepaymentCommand ChargeRepaymentCommand);

	@Transactional
	void applyMeetingDateChanges(Calendar calendar,
			Collection<CalendarInstance> chargeCalendarInstances,
